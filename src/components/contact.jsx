        ...
        <div className='contact animate-box fadeInUp animated ' >
            <form id="formFeedback ">
                <div className="form-group">
                    <label htmlFor="exampleFormControlInput1" className='text-white'>Ad və Soyad</label>
                ...
                <div className="form-group">
                    <label htmlFor="exampleFormControlInput1" className=' text-white'>Email address</label>
                    <input type="email" className="form-control" name="email" id="exampleFormControlInput2" required
                        placeholder="name@example.com"></input>
                </div>
                <div className="form-group">
                    <label htmlFor="exampleFormControlTextarea1" className=' text-white'>Təklif və iradlarınızı bizimlə bölüşün</label>
                    <textarea type="text" className="form-control" name="mesagge" rows="2"></textarea>
                </div>
                <button id="submitEmail " type="submit" className="btn btn-outline-success my-2 my-sm-0 text-white" onClick={handleClick}>Göndər</button>
            </form>
