...
İlk olaraq ‘Callback’ funksiyasına aid bir misal göstəcəm və izahı onun üzərindən verəcəm .</p>
    <img src={News1}  alt="" />
    <h6>Şəkil-1</h6>
    <p>Sol hissədə yazdığım kod blokuna fikir versəz görəcəksiz ki, biz buttona click etdiyimiz zaman ilk olaraq setTimeout() funksiyasının çölündəki kod işə düşərək success yazısını ekrana yazdırdı , sonra isə setTimeout() funksiyası işə düşdü və 2 saniyyə sonra ikinci success yazısını ekrana yazdırdı .</p>
    <img src={News2} alt="" />
    <h6>Şəkil-2</h6>
    ...
    <img src={News4} alt="" />
    <h6>Şəkil-4</h6>
    <p>Sol hissədə qeyd etdiyim kodlara nəzər salsaz görəcəksiniz ki ,Callback ilə push edəcəyimiz funksiyanın içərisinə bir funskiya daha yazırıq və onu parametr olaraq çağırırıq . Daha sonra isə ümumi datalarımızı çağırdığımız funksiyanı parametr olaraq yazırıq və istədiyimiz nəticəni alırıq</p>
